			...
			value: function render() {
				...
				switch (mode) {
					case "Form":
						...
						return _react2.default.createElement(_LoginForm2.default, { message: message });
					case "Loading":
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginStore = function (_ReduceStore) {
		...
		_createClass(LoginStore, [{
			key: "getInitialState",
			value: function getInitialState() {
				return _immutable2.default.Map({ mode: "Form", message: "" });
			}
		}, {
			key: "reduce",
			value: function reduce(state, action) {
				switch (action.type) {
					...
					case _LoginActionTypes2.default.LOGIN_SET_MESSAGE:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginActions = {
		...
		setMessage: function setMessage(message) {
			_Dispatcher2.default.dispatch({
				type: _LoginActionTypes2.default.LOGIN_SET_MESSAGE,
				message: message
			});
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HomeStore = __webpack_require__(64);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"h1",
						null,
						"\u0417\u0434\u0435\u0441\u044C Home \u0437\u0430\u043B\u043E\u0433\u0438\u043D\u0438\u0432\u0448\u0435\u0433\u043E\u0441\u044F \u0430\u0434\u043C\u0438\u043D\u0430"
					),
					_react2.default.createElement(
						"button",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HomeActionTypes = __webpack_require__(66);
	...
	var HomeStore = function (_ReduceStore) {
		...
		_createClass(HomeStore, [{
			...
			value: function reduce(state, action) {
				switch (action.type) {
					case _HomeActionTypes2.default.HOME_GET_ROLE:
						return state.set("cls", action.cls);
					default:
						return state;
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HomeActions = {
		getRole: function getRole() {
			_Dispatcher2.default.dispatch({
				type: _HomeActionTypes2.default.HOME_GET_ROLE
			});
		}
	};
